  ...
  servicesPage: {
    ...
    serviceCategories: [
      ...
      },
      {
        ...
        icon: CleanHandsIcon,
        services: ['cleanings', 'scaling']
      },
      {
        id: 'general',
        title: 'General Dentistry',
        icon: ConstructionIcon,
        services: ['resinFillings', 'crowns', 'bridges']
      },
      {
        id: 'oralSurgery',
        title: 'Oral Surgery',
        icon: ScienceIcon,
        services: ['extractions', 'implants', 'boneGrafting']
      },
      {
        id: 'prosthetics',
        title: 'Prosthetics',
        icon: BuildIcon,
        services: ['partials', 'complete', 'snapIn', 'screwIn', 'flippers']
      },
      {
        id: 'cosmetics',
        title: 'Cosmetic Dentistry',
        icon: SpaIcon,
        services: ['whitening', 'veneers', 'bonding', 'botox']
      },
      {
        id: 'tmjd',
        title: 'TMJ & Jaw',
        icon: FavoriteIcon,
        services: ['nightGuards', 'tmj']
      },
      {
        id: 'sleep',
        title: 'Sleep Apnea',
        icon: BedtimeIcon,
        services: ['sleepAppliances']
      },
      {
        id: 'ortho',
        title: 'Orthodontics',
      ...
      },
      {
        ...
        services: ['laughingGas', 'oralSedation']
      },
      {
        id: 'holistic',
        title: 'Holistic Dentistry',
        icon: PsychologyAltIcon,
        services: ['holistic', 'fluorideFree']
      }
    ],    
    categories: [
      {
